...
//The program is written in nano. This is version 2(c),with multiplier -256 and multiplicand -252645136.
...
main:
     ...
     mov multiplicand, -252645136                                                          //multiplicand =  -252645136
     mov multiplier, -256                                                                  //multiplier = -256
