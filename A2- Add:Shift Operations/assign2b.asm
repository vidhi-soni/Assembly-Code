...
//The program is written in nano. This is version 2(b),with multiplier 200 and multiplicand 522133279
...
main:
     ...
     mov multiplicand, 522133279                                                           //multiplicand =  522133279
     mov multiplier, 200                                                                   //multiplier = 200
